  ...
  data(){
    return {
      ...
      explanation: {
        ...
        '소녀적인 분위기의 테마로 연약한 색상인 페일톤이 자주 사용됩니다.'],
        'feminine': ['가장 여성스러움을 연출할 수 있는 스타일입니다.',
        ...
        '빨간 립스틱과 복고풍 헤어스타일 등 옛 시절을 떠올리게 합니다.'],
        ...
        'avantgarde': ['격식ㆍ전통에 영향을 받지 않고 새로운 것을 창조하는 스타일입니다.', 
        '유행에 앞선 독창적이고 기발한 디자인이 특징입니다.'],
        'western': ['활동미와 야성적 이미지를 표현하는 스타일입니다.', 
        '프린지 디테일, 올 데님, 웨스턴 부츠 등을 주로 홀용합니다.'],
        'oriental': ['동양적인 신비를 나타낸 스타일입니다.', 
        '마레이온이나 마아크릴, 자카드 등 광택이 좋은 소재를 주로 사용합니다.'],
        ...
        'hiphop': ['헐렁하고 편안한 스타일입니다. 다양한 코디ㆍ액세서리로 세련된 연출이 가능합니다.', 
        ...
        '반항적이고 창의적인 느낌을 주며, 도발적인 문구가 적힌 티셔츠, 가죽 재킷 등이 사용됩니다.'],
        'military': ['군복풍의 요소를 디자인에 도입한 스타일입니다.', 
        '견장이나 브레이드, 금속 단추 등으로 군복풍을 강조하기도 합니다.']
      }
    }
  },
  methods:{
